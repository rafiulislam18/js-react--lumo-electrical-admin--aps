...
const CustomerStats: React.FC = () => {
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-gray-100 bg-white p-4 shadow-sm transition-all duration-300 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-purple-100">
      <div className="pointer-events-none absolute -top-10 -right-10 h-28 w-28 rounded-full bg-purple-100/60 blur-2xl transition-opacity duration-300 group-hover:opacity-80" />
      <div className="absolute left-0 top-0 h-full w-1 bg-gradient-to-b from-purple-400 to-fuchsia-600" />

      <div className="relative">
        <div className="mb-3 flex items-center justify-between">
          <p className="text-xs font-semibold uppercase tracking-wider text-gray-600">Customers</p>
          <div className="rounded-lg bg-gradient-to-br from-purple-100 to-fuchsia-100 p-1.5 shadow-sm">
        ...
        <div className="mb-3 grid grid-cols-2 divide-x divide-gray-100 gap-3">
          <div>
            ...
            <p className="text-sm font-bold text-gray-900">+{newCustomersThisMonth}</p>
          </div>
          <div className="pl-3">
            <p className="mb-1 text-xs font-medium text-gray-500">Last Month</p>
            <p className="text-sm font-bold text-gray-500">+{newCustomersLastMonth}</p>
          </div>
        </div>
