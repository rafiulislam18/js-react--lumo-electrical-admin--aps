...
import { Search, Plus, Bell, CreditCard as Edit3, Menu } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div className="flex items-center gap-2 lg:hidden">
            ...
            <span className="text-xl font-bold text-gray-900 tracking-tight">Duka</span>
          </div>
        </div>
        ...
        <div className="flex items-center gap-2 lg:gap-3">
          ...
          <button className="p-2 lg:p-3 text-gray-500 hover:text-gray-700 hover:bg-gray-100 rounded-xl transition-all duration-200 hidden sm:block">
            <Edit3 size={18} lg:size={20} />
          </button>
